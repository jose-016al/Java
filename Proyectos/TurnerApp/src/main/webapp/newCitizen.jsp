                        ...
                        <div class="card shadow mb-4 col-12 col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-5">
                                    ...
                                    <form action="SvCitizen" method="POST" class="user">
                                        <div class="form-group">
                                            <label for="name">Nombre</label>
                                            <input type="text" name="name" class="form-control rounded" placeholder="Peter" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="surname">Apellidos</label>
                                            <input type="text" name="surname" class="form-control rounded" placeholder="Anthony" required>
                                        </div>
                                        <div class="form-group">
